...
class SpringDocConfigurationTest {
    ...
    private static final String CONTACT_NAME = "A Contact";
    private static final String CONTACT_URL = "https://contact.info";
    private static final String EXTERNAL_DOC_DESC = "An External Doc";
    private static final String EXTERNAL_DOC_URL = "https://external-docs.info";
    private static final String LICENSE_NAME = "A License";
    private static final String LICENSE_URL = "https://license.info";
    private static final String TERM_OF_SERVICE = "A Term of Service";
